...
path_dir = {'/users/bionanonmri/nohra/Documents/MATLAB/data/donnees_dep_cisaillement.don', ...
            ...
            '/users/bionanonmri/nohra/Documents/MATLAB/results/201123/'};
...
amplitude_bruit_Gaussien_U = 0.05:0.05:0.5; % pourcentage de norme_U_max

valNoise = zeros(length(amplitude_bruit_Gaussien_U),nb_iter_LDC_max+1);

[t_ini_identification, sTime] = deal(zeros(1,length(amplitude_bruit_Gaussien_U)));
