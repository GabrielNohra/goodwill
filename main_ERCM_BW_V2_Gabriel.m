...
path_dir = {'/users/bionanonmri/nohra/Documents/MATLAB/data/donnees_dep_cisaillement.don', ...
            ...
            '/users/bionanonmri/nohra/Documents/MATLAB/results/161123/initialValues/elastic',...
            '/users/bionanonmri/nohra/Documents/MATLAB/results/161123/initialValues/viscous',...
            '/users/bionanonmri/nohra/Documents/MATLAB/results/161123/initialValues/'};
...
for j_param = 1:2
    for i_param = 2:length(devFactor)
        ...
        clear lambda_r0 lambda_i0 rho_0 vec_numeros_parametres_comportement vec_numeros_parametres_masse vec_numeros_parametres_a_identifier vec_numeros_parametres_fixes seuil_identification_min seuil_identification_max vec_borne_min_param_identification vec_borne_max_param_identification seuil_relaxation_bornes_min_max;
        ...
        sTime(j_param,i_param) = cputime - t_ini_identification(j_param,i_param);

        valInitial(j_param,i_param,1:length(cell2mat(liste_proprietes_iterations))) = cell2mat(liste_proprietes_iterations);
        ...
        for n_param = 1:size(liste_proprietes_iterations{n_iter_LDC},1)
            ...
            tl = title('Material property $\mu$','interpreter','latex');
