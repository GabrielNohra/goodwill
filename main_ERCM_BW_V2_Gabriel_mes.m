...
while count <= sizeM
    ...
    processText(amplitude_bruit_Gaussien_U, kappa, n_iter_LDC, devMes,vec_U_mes, path_dir{end}, mat_proprietes_identifies_moyennes_sub_zones,liste_proprietes_iterations, vec_difference_proprietes);
