...
%  [Ke,Me] = matrices_elem_ERCM (liste_elem_ref,liste_elem_pha,struct_param_masse_raideur,elem_sig,mat_pos_sig,nb_DDL_par_noeud,struct_param_comportement_a_identifier);
  [Ke,Me,d_Ke_d_p] = matrices_elem_ERCM (liste_elem_ref,liste_elem_pha,struct_param_masse_raideur,elem_sig,mat_pos_sig,vec_correspondance_n_noeud_pha_global_n_noeud_pha_local,nb_DDL_par_noeud,struct_param_comportement_a_identifier);
